...
@can('folder_access_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.folders_access.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.folder_access.access_folder') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.folder_access.access_folder') }} {{ trans('global.list') }}
    </div>
